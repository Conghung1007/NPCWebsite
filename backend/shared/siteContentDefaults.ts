...
export const JAPANESE_CONTENT_DEFAULTS: Record<string, string> = {
  ...
  "why-description": "Những lý do bạn nên chọn dịch vụ của trung tâm chúng tôi",
...
export const HOME_CONTENT_DEFAULTS: Record<string, string> = {
...
export const STUDY_ABROAD_CONTENT_DEFAULTS: Record<string, string> = {
  ...
  "services-description": "Bốn nhóm hỗ trợ trọng tâm — rõ ràng, không chồng chéo",
  ...
  "service-3-description": "Visa du học, chỗ ở, bảo hiểm và hỗ trợ khi đã đến trường",
...
export const VISA_CONTENT_DEFAULTS: Record<string, string> = {
  ...
  "documents-by-type": JSON.stringify({
    tourism: [
...
export function getSiteContentDefaults(
  ...
  switch (page) {
    ...
    case "japanese":
      return JAPANESE_CONTENT_DEFAULTS;
    case "home":
