...
export function Footer() {
  ...
  return (
    <footer className="bg-gray-900 text-white py-12 sm:py-16 w-full max-w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-8 lg:mb-12 w-4/5 max-w-4/5 mx-auto">
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center mb-4 lg:mb-6">
              <span className="text-2xl sm:text-3xl font-bold text-primary mr-2">
                {portal === "tnjs"
                  ? "TNJS"
                  : portal === "duhoc"
                    ? "Du học"
            ...
            <div className="flex space-x-3 justify-center sm:justify-start">
              <a
                href="#facebook"
                className="w-8 h-8 sm:w-10 sm:h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-primary transition-colors"
              >
          ...
          <div>
            <h3 className="text-base sm:text-lg font-semibold mb-4 lg:mb-6 text-center sm:text-left">
              {portal === "tnjs" ? "TNJS" : "Cổng dịch vụ"}
            </h3>
          ...
          <div>
            ...
            <div className="space-y-2 lg:space-y-3 text-gray-400 text-center sm:text-left">
              {contactInfos.length > 0 ? (
                contactInfos
                  .filter((info) =>
                    ["main_office", "hotline", "email"].includes(info.type),
                  )
                  .map((info) => (
