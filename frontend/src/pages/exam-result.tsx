...
import { Trophy, Clock, Target, CheckCircle, XCircle, RotateCcw, Home, Share2, BookOpen, MessageSquare, Headphones, FileInput, ArrowLeft, Award, Shield } from "lucide-react";
...
export function ExamResultPage({ attemptId }: ExamResultPageProps) {
  ...
  let scoreBadge;
  if (examPassed) {
    scoreBadge = getScoreBadge(scorePercentage);
  } else {
    ...
    >
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <h5 className="text-base font-semibold text-green-600 mb-3">CERTIFICATE OF RESULT AND SCORES</h5>
        </div>
